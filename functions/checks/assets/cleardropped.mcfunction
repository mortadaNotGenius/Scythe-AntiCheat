...
# xray
execute as @s[type=item,name="Ancient Debris",rx=0,rxm=0,ry=0,rym=0] run execute as @p[r=5,scores={xray=..0}] run tellraw @a[tag=notify] {"rawtext":[{"text":"§r§6[§aScythe§6]§r §4[Xray]§r "},{"selector":"@s"},{"text":" has found §g1x Ancient Debris."}]}
execute as @s[type=item,name="Diamond",rx=0,rxm=0,ry=0,rym=0] run execute as @p[r=5,scores={xray=..0}] run tellraw @a[tag=notify] {"rawtext":[{"text":"§r§6[§aScythe§6]§r §4[Xray]§r "},{"selector":"@s"},{"text":" has found §g1x Diamond."}]}
