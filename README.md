...
To ban a player use: ```/execute as <playername> run function ban```

To freeze a player use: ```/execute as <playername> run function tools/freeze```

To enter vanish use: ```/function tools/vanish```

To be able to fly in survival mode use: ```/function tools/fly```

To view a players anticheat logs use: ```/execute as <playername> run function tools/stats```

To clear someones ender chest use: ```/execute as <playername> run function tools/ecwipe```
